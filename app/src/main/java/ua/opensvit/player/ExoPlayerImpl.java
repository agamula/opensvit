 ...
 */
public class ExoPlayerImpl implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    public interface RendererBuilder {
         ...
         */
        void buildRenderers(ExoPlayerImpl player, RendererBuilderCallback callback);
    }
    ...
    public interface RendererBuilderCallback {
         ...
         *
         * @param trackNames The names of the available tracks, indexed by {@link ExoPlayerImpl} TYPE_*
         ...
         *     indexed by {@link ExoPlayerImpl} TYPE_* constants. May be null if there are no types with
         *     multiple tracks. An individual element may be null if it does not have multiple tracks.
         * @param renderers Renderers indexed by {@link ExoPlayerImpl} TYPE_* constants. An individual
    ...
    public ExoPlayerImpl(RendererBuilder rendererBuilder) {
    ...
    public void onPlayerStateChanged(boolean playWhenReady, int state) {
        ...
        boolean startTrack = playbackState == ExoPlayer.STATE_IDLE && lastReportedPlaybackState ==
                ExoPlayer.STATE_BUFFERING;
        maybeReportPlayerState();
        if(startTrack) {
            selectTrack(TYPE_VIDEO, 0);
        }
    }
    ...
    private class InternalRendererBuilderCallback implements RendererBuilderCallback {
        ...
        public void onRenderers(String[][] trackNames, MultiTrackChunkSource[] multiTrackSources,
                                TrackRenderer[] renderers, BandwidthMeter bandwidthMeter) {
            if (!canceled) {
                ExoPlayerImpl.this.onRenderers(trackNames, multiTrackSources, renderers, bandwidthMeter);
            }
        }
        ...
        public void onRenderersError(Exception e) {
            if (!canceled) {
                ExoPlayerImpl.this.onRenderersError(e);
            }
        }
