...
import ua.ic.levtv.library.LevtvStruct.IptvOsdStruct;
import ua.ic.levtv.library.LevtvStruct.IptvOsdStruct.Programs;
...
public class VideoViewPlayer extends Activity {
    ...
    public void onCreate(Bundle paramBundle) {
        ...
        this.api = MyApplication.getInstance().getDbApi();
        if (this.type == 0) {
        }
